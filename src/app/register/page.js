  ...
  return (
    <div className='flex h-screen w-screen justify-center align-middle'>
        <div className='flex flex-col space-y-3 justify-center'>
            ...
            <input type="text" placeholder="E-mail" class="input input-bordered input-secondary w-full max-w-xs" />
            <input type="text" placeholder="Senha" class="input input-bordered input-secondary w-full max-w-xs" />
